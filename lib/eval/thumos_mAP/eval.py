...
def evaluation_proposal(eval_file):

    ground_truth_filename = 'data/thumos14.json'
...
def evaluation_detection(eval_file):

    ground_truth_filename = '/home/hsyang/code/MM/Transfomer/lib/thumos_AR/thumos_mAP/data/thumos14.json'
